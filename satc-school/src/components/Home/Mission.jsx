  ...
  return (
    <section className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
      ...
      <div className="space-y-5 leading-relaxed">
        ...
        <p>
          We believe that all forms of communication count! Communication is the
          foundation of social connection, community, and independence. Through
          structured learning, sensory-friendly classrooms, and supportive
          interventions, we empower our students to thrive academically,
